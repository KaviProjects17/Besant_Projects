...
IF(APPLICANTINCOME < 5000 AND PROPERTY_AREA ="SEMIRURAL",3.5,IF(APPLICANTINCOME < 5000 AND PROPERTY_AREA ="URBAN",5,
...
create table loan_status(loan_id varchar(60),customer_id varchar(60),loan_amount varchar(50),loan_amount_term int,cibil_score int);
